...
<html lang="en">
  <head>
        ...
        <title>Latest Freshers Walk Interviews Jobs in Kolkata August 2018</title>
...
lkgtopg
todaywalkins
jobs for graduate in kolkata
walkins in kolkata
kolkata walkins
offcampus drive in kolkata

freshers jobs,kolkata jobs
kolkata jobs 2018,
kolkata jobs for freshers,
kolkata jobs vacancy,
kolkata walkin,
kolkata walkin interview,
kolkata walkins today,
">
...
{ 
  ...
  $sql = mysqli_query($conn, "SELECT *FROM jobss  WHERE  location='Kolkata' ORDER BY id DESC LIMIT 32 ");
