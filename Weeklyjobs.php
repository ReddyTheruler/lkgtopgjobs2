...
<html lang="en">
  <head>
        ...
        <title>Weekly Jobs  Interviews Freshers Jobs August 2018</title>
...
#$sam = $_GET['sname'];
#echo $sam; $datee = date('Y-d-m', strtotime($same)); 

#echo $datee;


#$date1 = strtr($_REQUEST['same'], '/', '-');
#echo date('Y-m-d', strtotime($date1));

#echo $date; echo $_REQUEST['sname']; echo $_REQUEST['$date'];
if(isset($_POST['btn_submit']))

{ 

$datee= $_POST['btn_submit'];
#echo $datee;
 
$date = date('Y-d-m', strtotime($datee)); 


$sql = mysqli_query($conn, "SELECT *FROM jobss  WHERE  noticedate LIKE '%".$datee."%' ORDER BY id DESC ");
...
echo "<center>";
echo "<br><br><br>";
echo "<strong>No Jobs Today- Please check More jobs here: <a href=\"http://lkgtopg.in/\" target=\"_blank\">Click Here</a></strong>";
echo "<br><br><br>";
echo "</center>";
