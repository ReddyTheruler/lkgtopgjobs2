...
<html lang="en">
  <head>
        ...
        <title>Walk In Jobs in Chennai - Lkgtopg jobs August 2018</title>
...
jobs in chennai
chennai jobs
chennai jobs for freshers
chennai fresher jobs
chennai today interview
chennai jobs walkins
chennai interviews
chennai walkin interviews ">
...
chennai jobs for freshers
chennai jobs for graduates
chennai jobs 2018 for freshers
chennai walkins
chennai walkins 2018
chennai walkin tommorow
chennai walkins jobs
chennai interview
chennai interviews tommorow">
...
{ 
  ...
  $sql = mysqli_query($conn, "SELECT *FROM jobss  WHERE  location='Chennai' ORDER BY id DESC LIMIT 32 ");
