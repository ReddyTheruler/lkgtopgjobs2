...
<html lang="en">
  <head>
        <title>Latest Freshers Walk Interviews Jobs in Bhubaneshwar August 2018</title>
...
{ 
  ...
  $sql = mysqli_query($conn, "SELECT *FROM jobss  WHERE  location='Bhubaneswar' ORDER BY id DESC LIMIT 32 ");
