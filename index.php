...
<html lang="en">
  <head>
        <title>LKGtoPG Freshers Walkins Jobs in Hyderabad  2018 August</title>
<link rel="canonical" href="http://lkgtopg.in/">
        ...
        <meta name="description" content="lkgtopg todaywalkins tommorow walkins graduate offcampus drive btech degree trainee in 
hyderabad jobs bangalore jobs mumbai jobs chennai jobs noida jobs delhi jobs pune jobs 
kolkata jobs ahmedabad jobs bhubneshwar jobs allindia jobs freshers software jobs 2018 
...
<meta property="og:description" content="lkgtopg todaywalkins tommorow walkins graduate offcampus drive btech degree trainee in 
hyderabad jobs bangalore jobs mumbai jobs chennai jobs noida jobs delhi jobs pune jobs 
kolkata jobs ahmedabad jobs bhubneshwar jobs allindia jobs freshers software jobs 2018 
...
<meta name="twitter:description" content="lkgtopg todaywalkins tommorow walkins graduate offcampus drive btech degree trainee in 
hyderabad jobs bangalore jobs mumbai jobs chennai jobs noida jobs delhi jobs pune jobs 
kolkata jobs ahmedabad jobs bhubneshwar jobs allindia jobs freshers software jobs 2018 
...
$sql = mysqli_query($conn, "SELECT *FROM jobss WHERE location='Hyderabad'  ORDER BY id DESC LIMIT 22");
...
{ 
  ...
  $sql = mysqli_query($conn, "SELECT *FROM jobss   ORDER BY id DESC LIMIT 22 ");
